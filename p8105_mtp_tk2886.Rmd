...
broad_trends %>%
  ...
  knitr::kable(caption = "When looking at the broad trends, the data validates the authors statement that FHP size over 40mm is more common in older subjects (among age group of 60+). In the above, it is indicated is it more common in the age population of 60+")
```
