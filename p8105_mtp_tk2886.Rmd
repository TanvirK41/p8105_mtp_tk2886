...
In each age group for sex there is **weak positive correlation** between FHP size and EOP size. 
...
```
The **reported rate for FHP size over 40mm and among age group of 60+** is  **34.5%**. This is slightly different from the r code calculation: **32.46%**. 
...
```
When looking at the broad trends, the data validates the authors statement that FHP is more common in older subjects with FHP size over 40mm and among age group of 60+ because in the *Table FH40*, it is indicated is it more common in the age population of 60+.
...
# **Part 4: Conclusion** 
My data analysis findings indicated that there is various misclassifications and inconstencies with the data that was provided. For example, individuals were grouped incorrectly, specific data values were not correctly labeled, and the calculated statistical value did not align with the author's values. The author explained what each data and figure represents, however the figures and conclusion the author arrived are not as useful and may not be valid because of the data misclassification. While my graphs show that younger adults (18-30 years of age) have higher rate of EEOP than other age group, we may not state that there is causal relationship between the usage of cell phone and horn growth because of the poor data. I would like researchers to gather data of how many hours individual uses cell phone and see if there's positive correlation between high usage hours of cell phone and EEOP. 
