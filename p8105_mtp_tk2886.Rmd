...
**FHP DISTRIBUTION PLOT:** The average FHP size of male is always larger than female. The FHP size variability increases as the age increases with age group 60+ having the highest FHP distribution. 


**EEOP RATE PLOT:** The trend of EEOP rate FIRST decreased and then increased for both gender (male and female). EEOP rates is higher in male population than in females among all age groups. The largest EEOP rate is in the 18-30 age group for both male and female and lowest rate is in 41-50 age group for both male and female. 
...
My data analysis findings indicated that there is various inconsistencies with the data that was provided. For example, individuals were grouped incorrectly, specific data values were not correctly labeled, and the calculated statistical value did not align with the author's values. The figures and conclusion the author arrived are not as useful and may not be valid because of the data misclassification. While my graphs show that younger adults (18-30 years of age) have higher rate of EEOP than other age group, we may not state that there is causal relationship between the usage of cell phone and horn growth because of the poor data. I would like researchers to first gather data on how many hours individual uses cell phone and see if there's positive correlation between high usage hours of cell phone and EEOP. 
