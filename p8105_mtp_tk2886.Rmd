...
eop_dfc %>% 
  ...
  knitr::kable(col.names = c(
    ...
    caption =
      "FHP Distribution - There is **One** NA, which means there is a data value for FHP size that does not fit in one of the FHP categories")
...
*Both male and female each have a single participant incorrectly defined.*
