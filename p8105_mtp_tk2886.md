...
eop_dfc %>% 
  ...
  knitr::kable(col.names = c(
    ...
    caption = 
    "EOP Distribution - There is **One** NA, which means there is a data value for EOP size that does not fit in one of the EOP size groups")
```
...
value for EOP size that does not fit in one of the EOP size groups
...
eop_dfc %>% 
  ...
  knitr::kable(col.names = c(
    ...
    caption =
      "FHP Distribution - There is **One** NA, which means there is a data value in FHP that does not fit in one of the FHP categories")
```
...
value in FHP that does not fit in one of the FHP categories
