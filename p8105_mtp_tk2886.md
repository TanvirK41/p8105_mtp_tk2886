...
*Both male and female each have a single participants’ data incorrectly
defined.*
...
that **28** is the mean for male and **24** is the mean for female.
...
size over 40mm. The **reported rate for FHP size over 40mm and among age
...
statement that FHP size over 40mm is more common in older subjects
(among age group of 60+). In the table above, it is indicated is it more
common in the age population of 60+
...
obversevred the most in 60+), *we may not state that there is causal
